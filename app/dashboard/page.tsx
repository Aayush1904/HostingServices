...
export default function Dashboard() {
    ...
    const handleDeploy = async () => {
        ...
        try {
            ...
            setW3name(name);
            console.log(
                `Deployed successfully. Transaction hash: ${txHash}, CID: ${cid}, URL: ${w3nameUrl || deploymentUrl
                }, W3name: ${name}`
            );
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            setDeployedUrl(w3nameUrl || deploymentUrl);
            console.log(
                `Updated successfully. Transaction hash: ${txHash}, CID: ${cid}, URL: ${w3nameUrl || deploymentUrl
                }`
            );
